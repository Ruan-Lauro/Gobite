...
import image from '../assets/projeto/img2.png'
...
export default function SecondInitialImg() {
  ...
  return (
        <ImageBackground source={image} resizeMode="cover" className="h-full w-full flex items-center justify-end brightness-[-20]" >
            ...
            <View className="px-7 pb-10 h-[50%] flex flex-col justify-end mb-6">
                ...
                <TouchableOpacity onPress={()=>navigation.navigate("Home")} className="bg-[#EF6820] rounded-full justify-center items-center h-14" ><Text className="text-white" >Continue</Text></TouchableOpacity>
